          ...
          <div className="relative flex min-h-screen flex-col bg-background">
            <div className="border-b">
              <div className="container flex-1 items-start xl:grid xl:grid-cols-[240px_minmax(0,1fr)_240px] max-md:px-0">
                <aside className="fixed top-14 z-30 -ml-2 hidden h-[calc(100vh-10rem)] w-full shrink-0 xl:sticky xl:block">
                ...
                <aside className="fixed top-14 z-30 -mr-2 hidden h-[calc(100vh-10rem)] w-full shrink-0 xl:sticky xl:block">
