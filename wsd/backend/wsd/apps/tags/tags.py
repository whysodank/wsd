...
class TagMaker:
    ...
    def contribute_to_class(self, cls, name):
        setattr(cls, self.tag_class_attribute_name, create_tag_class(cls))
        setattr(cls, self.tag_through_class_attribute_name, create_object_tag_class(cls, name))
        m2m_field = models.ManyToManyField(create_tag_class(cls), through=create_object_tag_class(cls, name))
