from apps.rest.v0.views import PostCategoryViewSet, PostCommentViewSet, PostTagViewSet, PostViewSet, UserViewSet
...
viewsets = [UserViewSet, PostViewSet, PostTagViewSet, PostCommentViewSet, PostCategoryViewSet]
